...
const CourseCard = ({course}) => {
  ...
  return (
    <Link to={'/course/'+course._id} onclick={()=>scrollTo(0,0,)} className='border border-gray-500/30 pb-6 oberflow-hidden rounded-lg'
    >
      <img src={course.courseThumbnail} alt="" className='w-full'/>
      <div className='p-3 text-left'>
        <h3 className='text-base font-semibold'>{course.courseTitle}</h3>
        <p className='text-gray-500'>CODE HELPER</p>
