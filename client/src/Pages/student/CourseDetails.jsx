...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateNoOfLectures,
     calculateCourseDuration, calculateChaperTime ,currency} = useContext(AppContext)
    ...
    <>
      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>CODE HELPER</span></p>
